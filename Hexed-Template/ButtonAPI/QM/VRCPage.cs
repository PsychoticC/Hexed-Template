...
namespace WorldAPI.ButtonAPI
{
    public class VRCPage : WorldPage
    {
        ...
        public VRCPage(string pageTitle, bool root = false, bool backButton = true, bool expandButton = false, Action expandButtonAction = null, string expandButtonTooltip = "", Sprite expandButtonSprite = null, bool preserveColor = false)
        {
            ...
            try
            {
                ...
                (backButtonGameObject.GetComponentInChildren<Button>().onClick = new Button.ButtonClickedEvent()).AddListener(new Action(() => {
                    if (IsRoot) QMUtils.GetMenuStateControllerInstance.Method_Public_Void_String_UIContext_Boolean_TransitionType_0("QuickMenuDashboard", null, false, UIPage.TransitionType.Left);
                ...
                (menuMask = MenuContents.parent.gameObject.GetOrAddComponent<VRC.UI.Elements.Controls.RectMask2DEx>()).enabled = true;
                gameObject.transform.Find("Scrollrect").GetOrAddComponent<VRC.UI.Elements.Controls.ScrollRectEx>().enabled = true;
                ...
                gameObject.transform.Find("Scrollrect/Viewport").GetComponent<VRC.UI.Elements.Controls.RectMask2DEx>().prop_Boolean_0 = true; // Fixes the items falling off of the QM
        ...
        public void AddExtButton(Action onClick, string tooltip, Sprite icon)
        {
            ...
            obj.GetComponent<UiToggleTooltip>()._localizableString = tooltip.ReturnLocalizableString();
        ...
        public void OpenMenu()
        {
            ...
            try
            {
                ...
                temp++;
                QMUtils.GetMenuStateControllerInstance.Method_Public_Void_String_UIContext_Boolean_TransitionType_0(Page.field_Public_String_0, null, false, UIPage.TransitionType.Left);
                temp++;
                OnMenuOpen?.Invoke();
                temp++;
                lastOpenedPage = this;
