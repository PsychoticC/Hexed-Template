...
namespace WorldAPI.ButtonAPI.Controls
{
    public class ButtonGroupControl : Root
    {
        ...
        public VRCToggle AddToggle(string Ontext, System.Action<bool> listener, bool DefaultState = false, string OffTooltip = null, string OnToolTip = null,
        ...
        public DuoToggles AddGrpToggles(string text, string Ontooltip, string OffTooltip, System.Action<bool> BoolStateChange,
            string text2, string Ontooltip2, string OffTooltip2, System.Action<bool> BoolStateChange2,
