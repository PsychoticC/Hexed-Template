...
namespace WorldAPI.ButtonAPI.Buttons.Groups
{
    public class DuoToggles : Root
    {
        ...
        public DuoToggles(GameObject menu, string text, string Ontooltip, string OffTooltip, System.Action<bool> BoolStateChange,
        ...
        public DuoToggles(ButtonGroupControl btnGrp, string text, string Ontooltip, string OffTooltip, System.Action<bool> BoolStateChange,
            string text2, string Ontooltip2, string OffTooltip2, System.Action<bool> BoolStateChange2,
            Sprite OnImageSprite = null, Sprite OffImageSprite = null,
            float FirstFontSize = 24f, float SecondFontSize = 24f, bool FirstState = false, bool SecondState = false) :
