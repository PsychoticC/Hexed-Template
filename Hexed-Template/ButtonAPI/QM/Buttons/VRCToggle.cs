...
namespace WorldAPI.ButtonAPI.Buttons
{
    public class VRCToggle : ToggleControl
    {
        ...
        public VRCToggle TurnHalfReturn(Vector3 pos, float fontSize)
        {
            TurnHalf();
        ...
        public VRCToggle(ButtonGroupControl buttonGroup, string text, System.Action<bool> stateChanged, bool DefaultState = false, string OffTooltip = "Off",
            string OnToolTip = "On", Sprite onimage = null, Sprite offimage = null, bool half = false)
            : this(buttonGroup, text, (val, _) => stateChanged(val), DefaultState, OffTooltip, OnToolTip, onimage, offimage, half) { }

        public VRCToggle(Transform menu, string text, System.Action<bool> stateChanged, bool DefaultState = false, string OffTooltip = "Off",
            string OnToolTip = "On", Sprite onimage = null, Sprite offimage = null, bool half = false)
